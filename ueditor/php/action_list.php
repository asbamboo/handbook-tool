...
switch ($_GET['action']) {
    ...
    case 'listfile':
        ...
        $path = rtrim($HANDBOOK_TOOL_CONFIG['HANDBOOK_ROOT'], '/') . '/file/' . ltrim($CONFIG['fileManagerListPath'], '/');
        break;
    /* 列出图片 */
    case 'listimage':
    default:
        ...
        $path = rtrim($HANDBOOK_TOOL_CONFIG['HANDBOOK_ROOT'], '/') . '/image/' . ltrim($CONFIG['imageManagerListPath'], '/');
